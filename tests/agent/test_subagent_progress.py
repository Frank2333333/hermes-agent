...
class TestBuildChildProgressCallback:
    ...
    def test_cli_spinner_tool_event(self):
        ...
        cb("tool.started", "web_extract", "quantum computing", {})
        output = buf.getvalue()
    ...
    def test_task_index_prefix_in_batch_mode(self):
        ...
        cb0("tool.started", "web_extract", "test", {})
        output = buf.getvalue()
        assert "[1]" in output
        ...
        cb2("tool.started", "web_extract", "test", {})
        output = buf.getvalue()
        assert "[3]" in output
    ...
    def test_single_task_no_prefix(self):
        ...
        cb("tool.started", "web_extract", "test", {})
...
class TestBatchFlush:
    ...
    def test_flush_sends_remaining_batch(self):
        ...
        cb("tool.started", "web_extract", "query1", {})
        ...
        summary_call = parent_cb.call_args_list[-1]
        summary_text = summary_call.kwargs.get("preview") or summary_call.args[2]
        assert "web_extract" in summary_text
