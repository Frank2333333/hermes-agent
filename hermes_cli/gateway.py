...
_PLATFORMS = [
    {
        ...
        "setup_instructions": [
            "1. Enable the internal OpenAI-compatible API entrypoint",
            "2. Bind it to a private interface or localhost only",
            "3. Keep it behind your enterprise network controls",
        ],
        "vars": [
            {"name": "API_SERVER_ENABLED", "prompt": "Enable API server (true/false)", "password": False,
             "help": "Set true to enable the internal API server entrypoint."},
            {"name": "API_SERVER_HOST", "prompt": "Bind host (default: 127.0.0.1)", "password": False,
             "help": "Use 127.0.0.1 or an internal bind address only."},
            {"name": "API_SERVER_PORT", "prompt": "Bind port (default: 8787)", "password": False,
             "help": "Port for the internal API server."},
        ],
    },
]
